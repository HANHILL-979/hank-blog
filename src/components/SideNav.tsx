      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          <img 
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAsNjWBr0UvFB-1u4mZw2dCrkS8N7YB4NjmMRPmAs0ktymYAnbpTUoRlXNXC6AmukFzbkUKHR4YLOkql_t-xI5m4ogHcLLsW1e10jRPwcCnVd4TeTpcwLXqliePikaspjO77jLKouBzgLsyCnKkabqnFd_8Pn966lTDZv2S7GRKuj1P8uQ-o9miXPaWnW0Eh1cOnNwN9isytwlwH5fPhlMKuRlTVH5fIMrzxWuaY-sOs4hdg0hldpN8FDGaMPtinn_GS2_4nWyVqbo"
            referrerPolicy="no-referrer"
          />
          <div>
            <h2 className="text-lg font-black tracking-tight text-zinc-900">Editorial</h2>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest">The Digital Curator</p>
          </div>
        </div>
      </div>
